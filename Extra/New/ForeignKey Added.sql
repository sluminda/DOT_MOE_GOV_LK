...
CREATE TABLE IF NOT EXISTS `institutions` (
  ...
  CONSTRAINT `fk_institutions_province` FOREIGN KEY (`ProCode`) REFERENCES `province`(`procode`),
  CONSTRAINT `fk_institutions_district` FOREIGN KEY (`DistrictCode`) REFERENCES `district`(`distcode`),
  CONSTRAINT `fk_institutions_zone` FOREIGN KEY (`ZoneCode`) REFERENCES `zone`(`zonecode`),
  CONSTRAINT `fk_institutions_division` FOREIGN KEY (`DivisionCode`) REFERENCES `division`(`divcode`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb3;
